...
public sealed class GeneratorTests
{
    ...
    public void EveryOperationAcceptsAtLeastWhatItsPerMethodPageLists()
    {
        ...
        // operation. reconcile went the other way: location.writeonly left Discovery, and its page
        // never listed it, so with no source left it is no longer accepted there.
        var spec = SpecLoader.Load(RepositoryRoot.Value, "v4");
        var contract = DiscoveryParser.Parse(spec);

        var expected = new Dictionary<string, int>(StringComparer.Ordinal)
        {
            ["health.users.dataTypes.dataPoints.list"] = 14,
            ["health.users.dataTypes.dataPoints.get"] = 12,
            ["health.users.dataTypes.dataPoints.rollUp"] = 12,
            ["health.users.dataTypes.dataPoints.dailyRollUp"] = 12,
            ["health.users.dataTypes.dataPoints.reconcile"] = 12,
    ...
    public void GeneratedSourcesCarryProvenanceAndNoEnvironmentState()
    {
        ...
        foreach (var file in files)
        {
            ...
            Assert.Contains("Discovery revision: 20260826", file.Content, StringComparison.Ordinal);
    ...
    public void EveryReachableSchemaIsEmitted()
    {
        ...
        // owners in Discovery revision 20260826.
    ...
    public void AnEnumValueThatWouldCollideWithItsNestedTypeNameIsRejected()
    {
        ...
        // 20260826 has no such value; if a later one introduces it, generation must stop with a
    ...
    public void MemberTypeCollisionsAreResolved()
    {
        ...
        // The three real CS0542 collisions in Discovery revision 20260826.
