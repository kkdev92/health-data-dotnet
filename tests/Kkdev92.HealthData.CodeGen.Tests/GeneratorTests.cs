...
public sealed class GeneratorTests
{
    ...
    public void UnreachableSchemasArePruned()
    {
        ...
        // 139 of the 151 declared schemas are reachable from the allowlisted operations. Revision
        // 20260909 declared four more: HeartRateVariabilityMetadata, which HeartRateVariability
        // references, and three GoogleDevicesandservicesHealthV4beta* schemas that nothing does.
        Assert.Equal(139, contract.Schemas.Count);
    ...
    public void GeneratedSourcesCarryProvenanceAndNoEnvironmentState()
    {
        ...
        foreach (var file in files)
        {
            ...
            Assert.Contains("Discovery revision: 20260909", file.Content, StringComparison.Ordinal);
    ...
    public void EveryReachableSchemaIsEmitted()
    {
        ...
        // owners in Discovery revision 20260909.
        Assert.Equal(43, containers);
        Assert.Equal(139, models.Length - helpers - containers);
